      ...
      <div class="side-inner">
        ...
        <div class="nav-menu">
          <ul>
            ...
            <li><router-link to="/questions"><span class="icon-notifications mr-3"></span>Questions</router-link></li>
            <li><router-link to="/addquestion"><span class="icon-notifications mr-3"></span>Poser une question</router-link></li>
          
            <li><a href="#"><span class="icon-sign-out mr-3"></span>Se connecter</a></li>
          </ul>
        </div>
      </div>
